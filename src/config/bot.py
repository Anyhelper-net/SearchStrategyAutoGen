...
class ENUM_MODEL_ID(Enum):
    ...
    ZOOM_BRAIN = 'V09Kb21DbHhvQ2oxRGVJbUVNSi9uQT09'
    GET_CLEAN_SALARY ='YmJ0eVdrN1YxNmJoTzBzS2MwL3UrQT09'
    GET_CLEAN_RESUME = 'cmFTU1RoMFFKZStpWmZERFhyMEh5QT09'
    GET_SIMPLE_RESUME = 'VEgxZGZtSHFGS0YwOGpnY0pIL3d0QT09'
    GET_FIRST_CHECK = 'b2dPak5WRmJOVTR2VFNnTjVSOXg4UT09'
    GET_FACT_CHECK = 'T2RYY044aUtZRUVIbDF3MEU2OVIxdz09'
